import { type AgentPreset, AGENT_PRESETS } from '#shared/agent-presets'
...
function loadFromStorage(): AppSettings {
  ...
  try {
    ...
    return {
      ...
      defaultCwd: typeof parsed.defaultCwd === 'string' ? parsed.defaultCwd : DEFAULT_SETTINGS.defaultCwd,
    }
  } catch {
